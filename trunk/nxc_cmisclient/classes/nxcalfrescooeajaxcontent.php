...
class nxcAlfrescoOEAjaxContent
{
    ...
    */
    public static function getInstance()
    {
        ...
        {
            self::$instance = new nxcAlfrescoOEAjaxContent();
        }
    ...
    */
    public static function simplify( $obj, $params = array() )
    {
        ...
        elseif ( !( $obj instanceof nxcAlfrescoObjectHandler ) or !$obj->hasObject() )
        {
            return array();
        }
        ...
        $alfrescoObject          = $obj->getObject();
        $ret                     = array();
        $attrtibuteArray         = array();
        $ret['name']             = $alfrescoObject->getTitle();
        //$ret['id']               = $alfrescoObject->getId();
        $ret['id']               = urlencode( urlencode( $alfrescoObject->getSelfUri() ));
        //$ret['encoded_id']       = nxcAlfrescoUtils::urlEncode( $alfrescoObject->getId() );
        $ret['encoded_id']       = urlencode( urlencode( $alfrescoObject->getSelfUri() ));
        $ret['owner_id']         = $alfrescoObject->getAuthor();
        $ret['class_name']       = $alfrescoObject->getDocType();
        $ret['class_identifier'] = $alfrescoObject->getClassIdentifier();
        $ret['is_container']     = $obj->isContainer();
        //$ret['url_alias']        = $alfrescoObject->getURI();
        $ret['url_alias']        = urlencode( urlencode( str_replace('/', '#slash#', $alfrescoObject->getSelfUri() ) ) );
