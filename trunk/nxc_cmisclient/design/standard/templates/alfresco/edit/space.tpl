...
<form action={'alfresco/edit'|ezurl} method="post" name="ObjectCreate">
                ...
                <div class="box-mr">
                    <div class="box-tl">
                        <div class="box-tr">
                            ...
                            <h1 class="context-title">{'folder'|class_icon( normal, 'Create space'|i18n( 'alfresco' ) )}&nbsp;{'Create space'|i18n( 'alfresco' )}</h1>
