<form action={'alfresco/remove'|ezurl} method="post" name="ObjectRemove">
        ...
        <div class="box-mr">
            <div class="box-content">
                ...
                <tr class="{$sequence}">
                    {* Object icon. *}
                    <td class="tight">
                        {if eq( $remove_item.class_identifier, 'folder' )}
                            {$remove_item.class_identifier|class_icon( small, $remove_item.summary|wash )}
                        {else}
