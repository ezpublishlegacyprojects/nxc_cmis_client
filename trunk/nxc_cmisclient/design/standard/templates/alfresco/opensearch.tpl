...
<form action={'/alfresco/opensearch/'|ezurl} method="get">
            ...
            <div class="box-tc">
                <div class="box-ml">
                    <div class="box-mr">
                        <div class="box-tl">
                            <div class="box-tr">
                                <h1 class="context-title">{'Search the repository using opensearch support'|i18n( 'alfresco' )}</h1>
                            ...
                            <div class="box-br">
                                <div class="box-content">
                                    ...
                                    {if $search_result}
                                        ...
                                        <tr class="{$sequence}">
                                            <td>
                                                <img src="{$object.alfresco_icon|wash}">&nbsp;<a href={concat( 'alfresco/browser/(id)/', $object.selfUri|urlencode|urlencode)|ezurl}>{$object.title|wash}</a>
                                            </td>
                                            <td>
                                                {$object.summary|wash}
                                            </td>
