{default $browser_view = 'cmis/browser'}
...
<div class="content-navigation">
    ...
    <div class="context-block">
        ...
        <form method="post" action={'cmis/action'|ezurl}>
                            ...
                            <div class="box-br">
                                ...
                                <div class="block">
                                    ...
                                    {if eq( $current_object.base_type, 'document' )}
                                        <div class="right">
                                            {$current_object.doc_type|mimetype_icon( small, $current_object.doc_type )} <a href={concat( 'cmis/download/', $current_object.self_uri )|ezurl}>{'Download'|i18n( 'cmis' )}</a>
                                        </div>
                                    {/if}
                                    <div class="break"></div>
...
{if eq( $current_object.base_type, 'folder' )}
    <form name="children" method="post" action={'cmis/action'|ezurl}>
