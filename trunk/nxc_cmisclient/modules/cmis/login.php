...
$errorList = array();
$redirectionURI = $http->hasPostVariable( 'RedirectURI' ) ? $http->postVariable( 'RedirectURI' ) : ( $http->hasSessionVariable( 'LastAccessesURI' ) ? $http->sessionVariable( 'LastAccessesURI' ) : 'cmis/browser' );
...
if ( $http->hasPostVariable( 'LoginButton' ) )
{
    ...
    catch ( Exception $error )
    {
        ...
        eZDebug::writeError( $error->getMessage(), 'cmis/login' );
    }
}
...
$Result['content'] = $tpl->fetch( "design:cmis/login.tpl" );
